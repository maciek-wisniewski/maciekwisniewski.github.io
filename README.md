...
1. **Home** - Welcome message and site overview with photo 
...
5. **Blog** - Personal blog posts and insights
...
Create and then edit the placeholder content in `index.html`:
...
Create and Edit `styles.css` to customize:
...
│   │   ├── 2026.json                   # Per year publications
│   │   ├── 2025.json                   # Per year publications
│   │   ├── 2024.json                   # Per year publications
│   │   └── 2023.json                   # Early career publications
│   ├── blog/                           # Blog content
│   │   ├── posts.json                  # Blog posts metadata
│   │   └── content/                    # Individual blog post content
│   │       └── flow-matching.md     # Flow Matching Blog Post
...
│   │       └── intro-to-bioinf-and-comp-genomics.md  # Sample course page
...
To change it:
1. Search for colors_pallete in `styles.css`
...
1. **Choose the appropriate year file** (e.g., `data/publications/2025.json`)
...
2. Add images with descriptive names: `rapiddock-paper-2024.jpg`
3. Reference in JSON: `"image": "assets/images/publications/rapiddock-paper-2024.jpg"`
